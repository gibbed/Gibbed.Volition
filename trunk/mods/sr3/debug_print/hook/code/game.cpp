...
bool HookGame(void)
{
	...
	// 970861 as DX9
	else if (UINT32(0x00B9A382) == 970861)
	{
		PatchCode(0x00E0F86C, &debugPrintAddress, 4);
		lua_gettop = (LUA_GETTOP)0x00DFDD50;
		lua_tolstring = (LUA_TOLSTRING)0x00DFE110;
		return true;
	}

	// 970861 as DX11
	else if (UINT32(0x00B99362) == 970861)
	{
		PatchCode(0x00E7DC6C, &debugPrintAddress, 4);
		lua_gettop = (LUA_GETTOP)0x00E02050;
		lua_tolstring = (LUA_TOLSTRING)0x00E02410;
		return true;
	}
