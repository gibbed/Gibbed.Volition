...
{
    internal class HeaderV3
    {
        public string Name;
        public string Path;
        public HeaderFlagsV3 Flags;
        ...
        public void Serialize(Stream output, Endian endian)
        {
            ...
            output.WriteValueEnum<HeaderFlagsV3>(this.Flags, endian);
        ...
        public void Deserialize(Stream input, Endian endian)
        {
            ...
            this.Flags = input.ReadValueEnum<HeaderFlagsV3>(endian);
