...
{
    public abstract class ResourceArrayElement : StringArrayElement
    {
        public ResourceArrayElement(ushort maximumLength)
            : base(maximumLength)
        {
        }
        ...
        public override void Read(Stream input, uint version, Endian endian)
        {
            ...
            input.Seek(4 * this.Items.Count, SeekOrigin.Current);
        }
