...
{
    public class Unknown007680Element : ISerializableElement
    {
        public class ArrayElement : SerializableArrayElement<Unknown007680Element>
        {
        }
        ...
        public void Read(Stream input, uint version, Endian endian)
        {
            ...
            var unknown8 = version >= 280 ? input.ReadValueS32(endian) : -1;
            ...
            if (version >= 228)
            {
                ...
                var unknown12 = input.ReadValueB8();
                var unknown13 = input.ReadValueB8();
            }
            ...
            if (version >= 240)
            {
                ...
                var unknown16 = input.ReadStringU16(64, Encoding.ASCII, endian);
